import { initDb } from '../dist/src/infra/db.js';
import { PointsRepository } from '../dist/src/infra/PointsRepository.js';
import { PointsService } from '../dist/src/domain/PointsService.js';
import { getTodayRangeJstIso } from '../dist/src/utils/jstDate.js';
async function testService() {
    try {
        ...
        const todayCount = await repo.countGiverTransactionsInRange(guildId, typeKey, giverUserId, range.fromIso, range.toIso);
